...
function chess!(r)
    p = corner_put!(r, Nord, Ost)
    v, g = corner_col!(r, Sud, West)
    ...
    stroka!(r, Ost, g)
    stroka!(r, Sud, v)
    gomove!(r, West, Nord, v, g)
    corner_put!(r, Nord, Ost)
    obratno!(r, Sud, West, p)
end

function gomove!(r, s, osn, vis, shir)
    t = 1
    while t < vis
       stroka!(r, s, shir)
       s = inverse(s)
...
function corner_col!(r, side1, side2)
    n1, n2 = 1, 1
...
function corner_put!(r, side1, side2)
    p = ""
    while !(isborder(r, side1) & isborder(r, side2))
        if ! isborder(r, side1)
            move!(r, side1)
